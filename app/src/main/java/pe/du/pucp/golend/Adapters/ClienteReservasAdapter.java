...
public class ClienteReservasAdapter extends RecyclerView.Adapter<ActividadAdapter.ViewHolder> {

    private ArrayList<Actividad> listaActividades;
    FirebaseDatabase firebaseDatabase;
    private Activity activity;
    public ClienteReservasAdapter(Activity actividad, ArrayList<Actividad> dataSet){
        activity = actividad;
