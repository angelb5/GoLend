    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (typeReservas){
            case "enCurso":
                ...
                reservasQuery = FirebaseFirestore.getInstance().collection("reservas").whereEqualTo("clienteUser.uid",user.getUid()).whereEqualTo("estado","Solicitud aceptada").whereEqualTo("horaFinReserva", null);
                break;
            case "pendientes":
            ...
            case "pasadas":
                ...
                reservasQuery = FirebaseFirestore.getInstance().collection("reservas").whereEqualTo("clienteUser.uid",user.getUid()).whereEqualTo("estado","Solicitud aceptada").whereNotEqualTo("horaFinReserva",null);
                break;
            case "rechazadas":
